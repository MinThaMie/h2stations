...
const STATUS_700_SMALL_API_ENDPOINT =
  'https://my.h2.live/ceemes/base.php?__type__=fuelstation&action=xmllist&__status_fueltype__=P700_SMALL&__show_permclosed__=1&__language__=en&__transform__=json&__fieldsin__=idx,name,combinedstatus,combinedremark&__t__=b13831e6243b9bcd4c74aeda55c1fe22';

const STATUS_350_SMALL_API_ENDPOINT =
  'https://my.h2.live/ceemes/base.php?__type__=fuelstation&action=xmllist&__status_fueltype__=P350_SMALL&__show_permclosed__=1&__language__=en&__transform__=json&__fieldsin__=idx,name,combinedstatus,combinedremark&__t__=b13831e6243b9bcd4c74aeda55c1fe22';

const STATUS_350_LARGE_API_ENDPOINT =
  'https://my.h2.live/ceemes/base.php?__type__=fuelstation&action=xmllist&__status_fueltype__=P350_LARGE&__show_permclosed__=1&__language__=en&__transform__=json&__fieldsin__=idx,name,combinedstatus,combinedremark&__t__=b13831e6243b9bcd4c74aeda55c1fe22';
